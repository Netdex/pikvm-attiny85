...
ifndef MICRONUCLEUS
    MICRONUCLEUS = $(MICRONUCLEUS_PATH)/micronucleus
endif
...
ifeq ($(strip $(NO_CORE)),)
    ...
    ifndef HEX_MAXIMUM_SIZE
        HEX_MAXIMUM_SIZE := $(call PARSE_BOARD,$(BOARD_TAG),menu.(chip|cpu|micronucleus).$(BOARD_SUB).upload.maximum_size)
        ifndef HEX_MAXIMUM_SIZE
...
do_upload:
		$(MICRONUCLEUS) --run $(TARGET_HEX) --no-ansi --timeout 60
